...
type Variant = "primary" | "outlineLight" | "primaryDark";
...
const variants: Record<Variant, string> = {
  primary:
    "bg-white text-brand-red-deep shadow-cta hover:-translate-y-0.5 hover:shadow-lg focus-visible:ring-white/80 focus-visible:ring-offset-brand-red",
  outlineLight:
